...
from .models import User, Dept, Class, Student, Attendance, Course, Teacher, Assign, AttendanceTotal, time_slots, DAYS_OF_WEEK, AssignTime, AttendanceClass, StudentCourse, NotificationTeacher, NotificationStudent, SNotification
...
def student_notification(request, student_id):
    ...
    for ass in ass_list:
        try:
            a = SNotification.objects.get(student=stud, course=ass.course )
        except SNotification.DoesNotExist:
